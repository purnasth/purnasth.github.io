    ...
    <>
      ...
      <main className="bg-gray-100 pb-12">
          ...
          {filteredProjects.map((project) => (
            ...
            >
              <div className="text-center">
                ...
                {/* <p className="line-clamp-2 max-w-md text-base mx-auto">
                    {project.description}
                  </p> */}
                <img
                  // src={project.landingImage[0]?.url}
        ...
        <div className="mt-12 flex items-center justify-center">
          {/* <Link to="#">← Mithila Yatri Niwas</Link> */}
          <Link
            to="/portfolio"
            className="transition-300 inline-flex items-center justify-center gap-2 rounded-full bg-dark px-8 py-4 text-center text-base font-medium uppercase text-white shadow outline outline-1 outline-dark hover:bg-dark/90 hover:tracking-widest hover:shadow-xl"
          >
            All Projects
            <sup className="green-gradient text-base font-bold">
              ({portfolioData[0].portfolioDetails.length})
            </sup>
          </Link>
          {/* <Link to="#">Hotel Himalaya →</Link> */}
        </div>
      </main>
    </>
  );
...
//     currentProjectIndex > 0 ? portfolioDetails[currentProjectIndex - 1] : null;
//   const nextProject =
//     currentProjectIndex < portfolioDetails.length - 1
//       ? portfolioDetails[currentProjectIndex + 1]
//       : null;
...
//               (currentProjectIndex + 2) % portfolioDetails.length,
//             )
//             .map((project) => (
//               <Link
//                 key={project.id}
...
//           <Link
//             to={`/portfolio/${portfolioDetails[(currentProjectIndex - 1 + portfolioDetails.length) % portfolioDetails.length].portfolioUrl}`}
//           >
//             ←{' '}
//             {
//               portfolioDetails[
...
//           </Link>
//           <Link
//             to={`/portfolio/${portfolioDetails[(currentProjectIndex + 1) % portfolioDetails.length].portfolioUrl}`}
//           >
//             {
//               portfolioDetails[
//                 (currentProjectIndex + 1) % portfolioDetails.length
