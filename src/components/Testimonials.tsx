          ...
          {portfolioDetails.map(
            (portfolio, index) =>
              index % 3 !== 2 && (
                <div
                  key={index}
                  className="transition-300 group flex items-start gap-12 rounded-2xl border border-light/20 bg-light/10 p-12 backdrop-blur hover:bg-light/20"
                >
          ...
          {portfolioDetails.map(
            (portfolio, index) =>
              index % 3 === 2 && (
                <div
                  key={index}
                  className="transition-300 group flex flex-col items-start gap-12 rounded-2xl border border-light/20 bg-light/10 p-12 backdrop-blur hover:bg-light/20"
                >
                  <span className="transition-300 flex aspect-square size-14 items-center justify-center rounded-full border bg-light text-center text-dark group-hover:border-light/50 group-hover:bg-light/30 group-hover:text-light">
                    <FaQuoteLeft className="text-3xl" />
                  </span>
                  <div>
                    ...
                    <div className="mt-8 flex flex-col items-start justify-between gap-8">
                      ...
                      <Link
                        to={`/portfolio/${portfolio.portfolioUrl}`}
                        className="transition-300 w-full rounded-full border border-light/50 bg-light/20 px-6 py-3 text-light hover:bg-dark hover:text-light group-hover:bg-light group-hover:text-dark"
                      >
                        View Case Study
                      </Link>
                    </div>
