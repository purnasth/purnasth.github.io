    ...
    <>
      <div className="mt-24 space-y-8">
        <div className="skills flex items-center justify-between">
          <h5 className="font-normal text-white/90">Frontend Development</h5>
          <span className="ml-4 flex-grow rounded-full border-2 border-dotted border-white/20"></span>
          <div className="flex items-center gap-8 rounded-full border border-white/50 bg-white/10 px-8 py-2">
        ...
        <div className="skills flex items-center justify-between">
          <h5 className="font-normal text-white/90">Backend Development</h5>
          <span className="ml-4 flex-grow rounded-full border-2 border-dotted border-white/20"></span>
          <div className="flex items-center gap-8 rounded-full border border-white/50 bg-white/10 px-8 py-2">
        ...
        <div className="skills flex items-center">
          <h5 className="font-normal text-white/90">UI/UX & Design Tools</h5>
          <span className="ml-4 flex-grow rounded-full border-2 border-dotted border-white/20"></span>
          <div className="flex items-center gap-8 rounded-full border border-white/50 bg-white/10 px-8 py-2">
        ...
        <div className="skills flex items-center justify-between">
          <h5 className="font-normal text-white/90">Collaboration Tools</h5>
          <span className="ml-4 flex-grow rounded-full border-2 border-dotted border-white/20"></span>
          <div className="flex items-center gap-8 rounded-full border border-white/50 bg-white/10 px-8 py-2">
        ...
        <div className="skills flex items-center justify-between">
          <h5 className="font-normal text-white/90">
        ...
        <div className="skills flex items-center justify-between">
          <h5 className="font-normal text-white/90">Other Tools</h5>
          <span className="ml-4 flex-grow rounded-full border-2 border-dotted border-white/20"></span>
          <div className="flex items-center gap-8 rounded-full border border-white/50 bg-white/10 px-8 py-2">
            {otherLogos.map((logo) => (
              <div
