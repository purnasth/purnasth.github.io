...
//           {/* <h2 className="text-4xl font-extralight">Purna Shrestha</h2> */}
...
import { TbPlus, TbMail } from "react-icons/tb";
import { Link } from "react-router-dom";
import { NavbarButtonProps } from "../../constant/types"; // Adjust this path based on where you place your types
